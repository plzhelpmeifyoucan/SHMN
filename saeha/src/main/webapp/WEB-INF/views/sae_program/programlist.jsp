...
<div><img src="/resources/programimg/${programlist.pg_filepath }" style="width:220px; height: 140px;">
</div>
...
<div style="font-size: 15.5px; padding-bottom: 4px;"><br><c:out value="${programlist.pg_startdate}" /> - <c:out value="${programlist.pg_enddate}" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
