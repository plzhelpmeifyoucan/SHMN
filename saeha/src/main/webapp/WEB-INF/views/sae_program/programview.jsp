		...
		<section id="container">
			<form name="readForm" role="form" method="post">
				<input type="hidden" id="pg_bno" name="pg_bno"
					value="${programread.pg_bno}" /> <input type="hidden" id="pg_name"
					name="pg_name" value="${programread.pg_name}" />
				<input type="hidden" id="pg_type" name="pg_type"
					value="${programread.pg_type}" />
			</form>
			<div class="form-group">
				<label for="pg_type" class="col-sm-2 control-laber"></label> <input
					type="text" id="pg_type" name="pg_type" class="form-control"
					value="${programread.pg_type }" readonly="readonly" />
			</div>
			...
			<div class="form-group">
				<label for="pg_name" class="col-sm-2 control-laber">관람 이름</label> <input
					type="text" id="pg_name" name="pg_name" class="form-control"
					value="${programread.pg_name}" readonly="readonly" />
			</div>
			<div class="form-group">
				<label for="pg_content" class="col-sm-2 control-label">관람 내용</label>
				<textarea id="pg_content" name="pg_content" class="form-control"
					readonly="readonly"><c:out
						value="${programread.pg_content}" /></textarea>
			</div>
			<div class="form-group">
				<label for="pg_stock" class="col-sm-2 control-laber">예약 가능
					인원</label> <input type="text" id="pg_stock" name="pg_stock"
					class="form-control" value="${programread.pg_stock}"
					readonly="readonly" />
			</div>
			<div class="form-group">
				<label for="pg_startdate" class="col-sm-2 control-laber">기간1</label>
				<input type="text" id="pg_startdate" name="pg_startdate"
					class="form-control" value="${programread.pg_startdate}"
					readonly="readonly" /> ~ <label for="pg_startdate"
					class="col-sm-2 control-laber">기간2</label> <input type="text"
					id="pg_enddate" name="pg_enddate" class="form-control"
					value="${programread.pg_enddate}" readonly="readonly" />
			</div>
			<%-- <div class="form-group">
				<label for="pg_time" class="col-sm-2 control-laber">관람 시간</label> <input
					type="text" id="pg_time" name="pg_time" class="form-control"
					value="${programread.pg_time}" readonly="readonly" />
			</div> --%>
