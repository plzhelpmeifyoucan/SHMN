...
<c:forEach items="${pimglist }" var="pimglist">
				<div class="form-grop">
					...
					<img src="/resources/programimg/${pimglist.ipath }" style="height: 400px; width:inherit;" />
				</div>
...
<span style="float: right;"><button type="button"   class="book_btn btn btn-primary">예매하기</button></span>
</div><br>
